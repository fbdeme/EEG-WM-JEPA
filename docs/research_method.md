...
| 벤치마크 | 태스크 | 메트릭 | 비교 대상 |
|---|---|---|---|
| **TUAB** | 정상/비정상 분류 | Accuracy, AUROC | Laya, LuMamba, BIOT, LaBraM |
| **TUSL** | 수면 단계 분류 (5-class) | Accuracy, Kappa | Laya, LuMamba |
| **BCI Competition** | 운동 상상 (MI) | Accuracy | S-JEPA, EEG-VJEPA |
| **TDBrain** | 질환 탐지 | Accuracy, F1 | LuMamba |
